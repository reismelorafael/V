...
static RmR_ISOraf_Store g_isorf_store;
static RmR_ISOraf_Page g_isorf_pages[65536u];
static uint64_t g_isorf_data[262144u];

static inline void rmr_isorf_allocator_init(void) {
